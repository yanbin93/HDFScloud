			...
			<div id="container_demo">
				...
				<div id="wrapper">
					<div id="login" class="animate form">
						<form action="checkUser?type=commonUser" method="post">
							 <h1>普通用户</h1>
							<p>
							...
							<p class="login button">
								...
								<input value="无帐号登录" onclick="javascript:location='trace.jsp'"></button>
							</p>
							<p class="change_link">
								companyUser ? <a href="companyLogin.html" class="to_register">
									Click here</a>
							</p>
								
							
							<p class="change_link">
							<a href="companyLogin.html" class="to_register">
									companyUser</a>
					...
					<div id="register" class="animate form">
						<form action="RegistServlet?type=commonUser" method="post">
							<h1>Sign up</h1>
							<p>
